...
def checkin():
    if request.method=='POST':
        ...
        msg = ['The host details seems to be incorrect, Retry?',
               'We have notified your host of your arrival, Have a nice day...']
...
def checkout():
    ...
    if request.method=='POST':
        ...
        msg = ["I don't feel so good Mr. Stark:), Network Issue",
               'You have been successfully checked out, see you soon...']
        session['msg'] = msg[flag]
